...
} from './deleteWeaponById';

describe('deleteWeaponById', () => {
  ...
  it('should fail if neither seriesId or bookId query params are passed', async () => {
    ...
    expect(WeaponsRepository.delete).not.toHaveBeenCalled();
  ...
  it('should fail if the weapon being deleted does not belong to a series', async () => {
  ...
  it('should fail if the weapon being deleted does not belong to a book', async () => {
  ...
  it('should delete the weapon by a specific id', async () => {
    const fakeWeapon = generateMockWeapon(series, [book]);
    const weapon = await weaponsRepository.create(fakeWeapon);
    await weaponsRepository.save(weapon);
    ...
    expect(WeaponsRepository.delete).toHaveBeenCalledWith(1);
